<template>
    <section class="flex flex-col items-center w-full mobile:mb-1 mb-6">
        <article :class="divClass">
            ...
            <button v-tooltip="'Add Task'"  @click="addTask"  class="flex-shrink-0 bg-sky-500 hover:bg-sky-700 border-sky-500 hover:border-sky-700 text-sm border-4 text-white px-2 mobile:ml-0 rounded" type="button">+</button>
