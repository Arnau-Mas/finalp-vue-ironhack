<template>
    <section>
        <div
            class="min-h-full flex items-center justify-center mobile:pt-12 sm:py-12 px-2 sm:px-6 lg:px-8"
        >
            <div class="bg-white rounded-lg p-10 max-w-md w-full space-y-8">
                ...
                >
                    ...
                    <div v-if="infoMessage" id="alert-1" class="flex p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200" role="alert">
                       <svg xmlns="http://www.w3.org/2000/svg" class="text-red-700 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <div v-if="infoMessage" class="ml-3 text-sm text-red-700 dark:text-red-800">
                            <span class="font-medium">trialtodoapp@gmail.com</span> is a test email in case don't want to register.
                        </div>
                        <button @click="closeInfoMessage" type="button" class="ml-auto -mx-1.5 -my-1.5 bg-red-100 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex h-8 w-8 dark:bg-red-200 dark:text-red-600 dark:hover:bg-red-300" data-dismiss-target="#alert-1" aria-label="Close">
