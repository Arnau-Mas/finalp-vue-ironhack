    ...
    <Disclosure as="nav" class="bg-white shadow-md" v-slot="{ open }">
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                ...
                >
                    <!-- Mobile menu button-->
                    <DisclosureButton
                        class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-cyan-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                    >
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        <a href="/"
                            ><img
                                ...
                                src="../assets/todo-letters-logo.png"
                                alt="todoapp"
                        /></a>
                        <a href="/"
                            ><img
                ...
                <div
                    class="text-gray-500 absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0"
                >
                    <!-- Profile dropdown -->
        ...
        <DisclosurePanel class="sm:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1">
                <DisclosureButton
                    as="a"
                    @click="changeNavMobile(1)"
                    :class="classMblBtn1"
                    aria-current="page"
                    >Tasks</DisclosureButton
                >
                <DisclosureButton
                    as="a"
                    @click="changeNavMobile(2)"
                    :class="classMblBtn2"
                    aria-current="page"
                    >Archived</DisclosureButton
                >
                <DisclosureButton
                    as="a"
                    @click="changeNavMobile(3)"
                    :class="classMblBtn3"
                    aria-current="page"
                    >Completed</DisclosureButton
                >
            </div>
        </DisclosurePanel>
    </Disclosure>
