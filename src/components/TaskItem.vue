<template>
   <div :class="classesString">
        ...
        <input disabled type="date" :value="taskTimeProp" class=" text-center focus:ring-0 appearance-none text-sm sm:text-md bg-transparent border-none w-32 py-1  leading-tight">
