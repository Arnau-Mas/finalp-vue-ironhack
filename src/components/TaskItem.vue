<template>
   <div :class="classesString">
        ...
        <input type="time" :value="taskTimeProp" class="bg-red-100 flex w-32 text-center focus:ring-0 appearance-none mobile:text-sm bg-transparent border-none px-0 py-1 leading-tight">
