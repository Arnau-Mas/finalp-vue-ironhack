<template>
   <div class="taskClass">
        ...
        <button v-tooltip="'Archive'" class="flex-shrink-0 border-transparent border-4 text-gray-500 hover:text-cyan-800 text-sm rounded" type="button">
        ...
        <button v-tooltip="'Completed'" class="flex-shrink-0 border-transparent border-4 text-cyan-500 hover:text-cyan-800 text-sm py-1 ml-2 mr-2  rounded" type="button">
